            ...
            searchProducts.length == 0 ? (
              <div>
                ...
                <form className="flex" onSubmit={handleSubmit}>
                  <input type="search" id="search-dropdown" className="block px-5 py-4 w-full text-lg text-gray-900 rounded-l-lg border border-r-0 border-gray-300" placeholder="Find accessories for your tool - enter model designation, article number or EAN code" required value={searchProductName} onChange={(e) => setSearchProductName(e.target.value)} />
              ...
              <div>
                ...
                <input className="block px-5 py-5 w-full text-lg text-gray-900 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 bg-[url('/elwotools-green.png')] bg-no-repeat bg-center bg-contain" value={searchProductName} disabled />
